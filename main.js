...
class ExecJsonAdapter {
  start(request, onEvent, onClose) {
...
class CodexAgentView extends ItemView {
  ...
  filterHistoryByAge(sessions, minDays, maxDays) {
    const now = Date.now();
